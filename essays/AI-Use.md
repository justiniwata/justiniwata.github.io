...
With the WODs, I would 

### 2. In-class Practice WODs

For the In-class practice WODs, I would try to attempt to do the WOD by itself and not ask AI for help, but when I reach a roadblock or just copy and paste a section of the WOD that I need help clarifying. For example, with one of the WODs, I asked ChatGPT, "To create test cases for this code that will work for this question and also check if the code is working." The output of this telling me it worked with also providing me test cases. 
